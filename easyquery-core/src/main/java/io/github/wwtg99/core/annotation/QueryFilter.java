...
/**
 * Annotation for field filter. Annotated on class field to indicate filter.
 *
 * @author wwtg99
 */
...
public @interface QueryFilter {
    ...
    Class<? extends IValueProcessorFactory> processorFactory() default
            DefaultValueProcessorFactory.class;
}
